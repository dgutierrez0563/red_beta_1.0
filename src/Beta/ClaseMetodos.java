 ...
 * 
 */
public class ClaseMetodos { //Clase de metodos apara las operaciones necesarias del sistema
    public String listaVacia="no hay usuarios registrados";
    Scanner entrada=new Scanner(System.in);
    //MenuInicio instancia2=new MenuInicio();
    ListaUsuarios instancia3=new ListaUsuarios();
...
//        while(temporal!=null){
//        if((usuarioN.equals(temporal.usuario)) && (claveN.equals(temporal.clave))){
//            String opc1;
//            do{
//            System.out.println();
...
/*--------------------------------------------------***---------------------------------------------*/    
    public void registroUsuario(){
                ...
                String descripcion=null,lugarEstudio=null,deporte=null,actividades=null;
                //String nombre,String apellidos, String sexo, String fechaNacimiento, String telefono, String correo,String direccion, String usuario, String clave, String descripcionPersonal, String lugarEstudio, String deporte, String actividades
                NodoUsuario nuevoUsuario = new NodoUsuario(nombre,apellidos,sexo,fechaNacimiento,telefono,correo,direccion,nombreUsuario, clave,descripcion,lugarEstudio,deporte,actividades);
                instancia3.insertarUsuarios(nuevoUsuario);
//                ListaUsuarios.insertarUsuarios(nuevoUsuario);
    ...
    public void mostrarDatosUsuario(NodoUsuario nombre){
        
    }
    public void mostrarUsuarioEncontrado(){
        String nombre="Juan";
        ListaUsuarios usuarios=instancia3.buscarPorNombre(nombre);
        NodoUsuario temp=usuarios.primero;
        while(temp!=null){
            mostrarDatosUsuario(temp);
        }
